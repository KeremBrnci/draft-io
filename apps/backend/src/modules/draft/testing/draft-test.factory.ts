...
export function buildTestPool(): readonly DraftPoolCard[] {
  return [
    ...
    buildTestDraftPoolCard({ cardId: 'a-1', playerId: 'player-a-1', overall: 89, displayName: 'Strong CM' }),
    buildTestDraftPoolCard({ cardId: 'b-1', playerId: 'player-b-1', overall: 86, displayName: 'Solid CM' }),
    buildTestDraftPoolCard({ cardId: 'c-1', playerId: 'player-c-1', overall: 82, displayName: 'Average CM' }),
    buildTestDraftPoolCard({ cardId: 'd-1', playerId: 'player-d-1', overall: 77, displayName: 'Risk CM' }),
    buildTestDraftPoolCard({
      cardId: 'chem-1',
